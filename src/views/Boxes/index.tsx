    ...
    <BoxesStyed>
      <Flex flexDirection="column" alignItems="center">
        ...
        <Text mt="32px" color="white">
          Mefibox contains various heroes with certain drop rates
        </Text>
        <Text mb="32px" color="white">
          The higher quality of the Mefi box is, the higher drop rate for the high quality Heroes is
        </Text>
        <Static />
        <Flex mt="32px">
          <Link to="/boxes/mother">
            <HorizontalCard
              bnbValue="19.99 BNB"
              mexiValue="1000 MEXI"
              backgroundImage={metaxizBg}
              itemImage={metaxizBox}
              title="METAXIZ BOX"
              remaining="Remaining boxes: 4000"
            />
          </Link>
        </Flex>
        <Flex mt="32px">
          ...
          <Link to="/boxes/legendary">
            <VerticalCard
              bnbValue="4.99 BNB"
              mexiValue="1000 MEXI"
              backgroundImage={legendaryBoxBg}
              itemImage={legendaryBox}
              title="LEGENDARY BOX"
              remaining="Remaining boxes: 4000"
            />
          </Link>
