  ...
  return (
    <div>
      <h5 className="text-[#F5F5F5] text-[32px] text-center">
        Launch your project on <span className="text-skyblue text-shadow">BitcityZ</span> now!
      </h5>
      ...
      <div className="text-center">
        <a
          ...
          rel="noreferrer"
          type="button"
          className="bg-skyblue mt-8 flex items-center justify-center mx-auto max-w-[202px] rounded-[20px] border-none text-[#212121] font-semibold h-[44px] shadow-blue"
        >
          Apply to launch
        </a>
      </div>
